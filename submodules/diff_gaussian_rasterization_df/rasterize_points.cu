...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
 RasterizeGaussiansBackwardCUDA(
    ...
    const torch::Tensor& dL_dout_depth, // TODO
    const torch::Tensor& dL_grad_out_flow, // TODO
    const torch::Tensor& dL_grad_out_acc, // TODO
	const torch::Tensor& sh,
	const int degree,
	const torch::Tensor& campos,
	...
	const bool debug) 
{
  ...
  torch::Tensor dL_dflow = torch::zeros({P, 3}, means3D.options());
  ...
  {  
	  ...
	  scale_modifier,
	  rotations.contiguous().data_ptr<float>(),
	  acc_depth.contiguous().data<float>(),
	  acc.contiguous().data<float>(),
	  min_depth,
	  max_depth,
	  cov3D_precomp.contiguous().data<float>(),
	  viewmatrix.contiguous().data<float>(),
	  ...
	  dL_dout_depth.contiguous().data<float>(), // TODO
	  dL_grad_out_flow.contiguous().data<float>(), // TODO
	  dL_grad_out_acc.contiguous().data<float>(), // TODO
